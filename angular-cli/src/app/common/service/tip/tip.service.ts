...
export class TipService {
  ...
  // 右下角通知框（后端接口调用的提示）
  notify(type = 'info', title = this.title, content = this.content){
	...
	enableModalDrag(refModal) {
		...
		const modalElement = refModal.containerInstance.elementRef.nativeElement.querySelector('.ant-modal-content');
